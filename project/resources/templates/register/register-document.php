<div class="title-section">Documentos</div>
<div class="body-section">
    ...
    <div class="row form-group">
        <label for="otherDoc" class="col-md-2 col-form-label">Outro:</label>
        <div class="col-md-9">
            <input type="text" class="form-control" id="otherDoc" name="otherDoc">
        </div>
    </div>
</div>
