        ...
        <form class="style-forms">
            ...
            <div class="scheduling-form">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pacient-name" id="pacient-name" placeholder="">
                </div>

                <div class="form-group">
                    <label for="pacient-phone">Telefone</label>
                    <input type="text" class="form-control" id="pacient-phone" name="pacient-phone" maxlength="11">
                </div>

                <div class="form-group">
                    <label for="pacient-mail">Email</label>
                    <input type="email" class="form-control" id="pacient-mail" name="pacient-mail" placeholder="">
                </div>
            </div>
